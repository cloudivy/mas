...
# ── Navigation — use Material icon strings, NOT emoji (emoji breaks Py 3.13) ──
pages = {
    "Experiment": [
        st.Page("pages/1_Simulation.py",    title="Run Simulation",   icon=":material/science:"),
        st.Page("pages/3_Mitigation.py",    title="Mitigation Run",   icon=":material/anchor:"),
    ],
    "Analysis": [
        st.Page("pages/2_ASI_Dashboard.py", title="ASI Dashboard",    icon=":material/bar_chart:"),
        st.Page("pages/4_Results.py",       title="Results & Export", icon=":material/table:"),
    ],
}
